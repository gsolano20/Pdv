 ...
 if(isset($_POST['product'])){
   ...
   if(empty($errors)){
	  ...
	  // $DataBase = MySqlDb::GetInstance();
       ...
       $query  .=" name ='{$p_name}',  barcode ='{$p_code}', quantity ='{$p_qty}',";
       $query  .=" buy_price ='{$p_buy}', sale_price ='{$p_sale}', categorie_id ='{$p_cat}',media_id='{$media_id}',excento='{$p_excento}'";
       $query  .=" WHERE id ='{$product['id']}'";
	//	$DataBase->Execute($query);
		//$json = $DataBase->getJsonData();
		//$result = json_decode($json);
		$result = find_by_JSONsql($query );
