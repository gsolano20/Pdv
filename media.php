            ...
            <div class="pull-right">
              ...
              <div class="form-group">
                <div class="input-group">
					<i  style="left: 24px;top: 2px; z-index: 1;"class="glyphicon glyphicon-search"></i>
                  <span class="input-group-btn">
                    <input type="file"  style="width: 30px;" name="file_upload" multiple="multiple" class="btn btn-primary btn-file"/>
				 </span>
